...
public class Config {
    ...
    public Config(JSONObject object) throws JSONException {
        ...
        imageBaseUrl = image.getString("secure_base_url");
        // get the poster size
        JSONArray posterSizeOptions = image.getJSONArray("poster_sizes");
        // use the option at index 3 or 342 as a fallback
        posterSize = posterSizeOptions.optString(3,"w342");
        // parse the backdrop sizes and use the option at index or w780 as a fallback
